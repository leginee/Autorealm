...
static wxString className=wxT("SkewDlg");

IMPLEMENT_DYNAMIC_CLASS(SkewDlg, wxDialog)

BEGIN_EVENT_TABLE(SkewDlg, wxDialog)
END_EVENT_TABLE()
 ...
 */
SkewDlg::SkewDlg(wxWindow *parent, wxWindowID id, const wxString& title,
    const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    wxLogTrace(className, wxT("Entering SkewDlg"));
    Create(parent, id, title, pos, size, style, name);
    wxLogTrace(className, wxT("Exiting SkewDlg"));
}
 ...
 */
bool SkewDlg::Create(wxWindow *parent, wxWindowID id, const wxString& title,
    const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    
    wxLogTrace(className, wxT("Entering Create"));

    wxLogTrace(className, wxT("Loading resource"));
    wxXmlResource::Get()->LoadDialog(this, GetParent(), wxT("dlgSkew"));
