...
#ifndef PUSHPIN_BUILDER_H
#define PUSHPIN_BUILDER_H
...
namespace subbuilderComponents
{
    ...
    /**
     * @brief A SubBuilder for building Pushpins in ARDocuments
     */
    class PushpinBuilder : public SubBuilder
    {
        public:
            /**
             * @brief A simple constructor to initialize the m_pinnum variable.
             */        
            PushpinBuilder() : m_pinnum(0) {};
        ...
        protected:
            /**
             * @brief The current pin number being worked on.
             */
            unsigned int m_pinnum;
    };
       
}   // namespace subbuilderComponents

#endif // PUSHPIN_BUILDER_H