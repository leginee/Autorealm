...
#ifndef POLY_LINE_MODEL_BUILDER_H
#define POLY_LINE_MODEL_BUILDER_H
...
namespace subbuilderComponents
{
    ...
    /**
     * @brief A SubBuilder for building PolyLineModel objects.
     */
    class PolyLineModelBuilder : public SubBuilder
    {
        public:
            /**
             * @brief A simple constructor to initialize the m_pointCounter variable.
             */        
            PolyLineModelBuilder() : m_pointCounter(0) {};
        ...
        protected:
            /**
             * @brief The count of points of the PolyLineModel.
             */
...
#endif  // POLY_LINE_MODEL_BUILDER_H