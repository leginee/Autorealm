...
#ifndef AR_DOCUMENT_BUILDER_H
#define AR_DOCUMENT_BUILDER_H
...
namespace subbuilderComponents
{
    ...
    /**
     * @brief A SubBuilder for building ARDocument objects.
     */
    class ARDocumentBuilder : public SubBuilder
    {
        public:
            /**
