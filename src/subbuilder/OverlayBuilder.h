...
namespace subbuilderComponents
{
    ...
    /**
     * @brief A SubBuilder for building Overlays in ARDocuments.
     */
    class OverlayBuilder : public SubBuilder
    {
        public:
            /**
             * @brief A simple constructor to initialize the m_overlaynum variable.
             */
            OverlayBuilder() : m_overlaynum(0) {};
        ...
        protected:
            /**
             * @brief The number of the last overlay being worked on.
             */
            unsigned int m_overlaynum;

    };
   
}   // namespace subbuilderComponents

#endif // OVERLAY_BUILDER_H