...
#ifndef VIEW_POINT_BUILDER_H
#define VIEW_POINT_BUILDER_H
...
namespace subbuilderComponents
{
    ...
    /**
     * @brief A SubBuilder for building ViewPointModel objects.
     */
    class ViewPointBuilder : public SubBuilder
    {
        public:
            /**
