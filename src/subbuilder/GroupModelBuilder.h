...
#ifndef GROUP_MODEL_BUILDER_H
#define GROUP_MODEL_BUILDER_H
...
namespace subbuilderComponents
{
    ...
    /**
     * @brief A SubBuilder for building GroupModels in ARDocuments.
     */
    class GroupModelBuilder : public SubBuilder
    {
        public:
            /**
