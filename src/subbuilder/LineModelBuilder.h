...
#ifndef LINE_MODEL_BUILDER_H
#define LINE_MODEL_BUILDER_H
...
namespace subbuilderComponents
{
    ...
    /**
     * @brief A SubBuilder for building LineModel objects.
     */
    class LineModelBuilder : public SubBuilder
    {
        public:
            /**
