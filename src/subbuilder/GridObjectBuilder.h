...
#ifndef GRID_OBJECT_BUILDER_H
#define GRID_OBJECT_BUILDER_H
...
namespace subbuilderComponents
{
    ...
    /**
     * @brief A SubBuilder for building GridObjectModel objects.
     */
    class GridObjectBuilder : public SubBuilder
    {
        public:
            /**
