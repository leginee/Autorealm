...
#ifndef CURVE_MODEL_BUILDER_H
#define CURVE_MODEL_BUILDER_H
...
namespace subbuilderComponents
{
    ...
    /**
     * @brief A SubBuilder for building CurveModel objects.
     */
    class CurveModelBuilder : public SubBuilder
    {
        public:
            /**
