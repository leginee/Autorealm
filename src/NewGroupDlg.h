 ...
 * @file
 */
#ifndef NEWGROUPDLG_H
#define NEWGROUPDLG_H
#include "globals.h"
 ...
 * FULLDESC
 */
class NewGroupDlg : public wxDialog {
    public:
        /**
         ...
         */
        NewGroupDlg(wxWindow *parent, wxWindowID id, const wxString& title,
        ...
        void NewGroupNameKeypress();
        void FormShow();
    private:
        DECLARE_DYNAMIC_CLASS(NewGroupDlg)
        DECLARE_EVENT_TABLE()
};
#endif //NEWGROUPDLG_H
