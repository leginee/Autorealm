 ...
 * @file
 */
#ifndef TFRACTALCURVETOOLHANDLER_H
#define TFRACTALCURVETOOLHANDLER_H
#include "globals.h"
...
/**
 * @class TFractalCurveToolHandler
 *
 * @brief This class is used to BRIEFDESC
 *
 * FULLDESC
 */
class TFractalCurveToolHandler : public TNormalCurveToolHandler {
    public:
        /**
         * @brief Default constructor
         */
        TFractalCurveToolHandler(wxDC* canvas);
...
#endif //TFRACTALCURVETOOLHANDLER_H
