 ...
 * @file 
 */
#ifndef SAVEVIEWDLG_H
#define SAVEVIEWDLG_H
#include "globals.h"
 ...
 * FULLDESC
 */
class SaveViewDlg : public wxDialog {
    public:
        /**
         ...
         */
        SaveViewDlg(wxWindow *parent, wxWindowID id, const wxString& title,
    ...
    private:
        DECLARE_DYNAMIC_CLASS(SaveViewDlg)
        DECLARE_EVENT_TABLE()
};
#endif //SAVEVIEWDLG_H
