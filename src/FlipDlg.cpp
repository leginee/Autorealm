...
static wxString className=wxT("FlipDlg");

IMPLEMENT_DYNAMIC_CLASS(FlipDlg, wxDialog)

BEGIN_EVENT_TABLE(FlipDlg, wxDialog)
END_EVENT_TABLE()
 ...
 */
FlipDlg::FlipDlg(wxWindow *parent, wxWindowID id, const wxString& title,
    const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    wxLogTrace(className, wxT("Entering FlipDlg"));
    Create(parent, id, title, pos, size, style, name);
    wxLogTrace(className, wxT("Exiting FlipDlg"));
}
 ...
 */
bool FlipDlg::Create(wxWindow *parent, wxWindowID id, const wxString& title,
    const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    
    wxLogTrace(className, wxT("Entering Create"));

    wxLogTrace(className, wxT("Loading resource"));
    wxXmlResource::Get()->LoadDialog(this, GetParent(), wxT("dlgFlip"));
