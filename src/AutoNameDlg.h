 ...
 * @file
 */
#ifndef AUTONAMEDLG_H
#define AUTONAMEDLG_H
#include "globals.h"
 ...
 * FULLDESC
 */
class AutoNameDlg : public wxFrame {
    public:
        /**
         ...
         */
        AutoNameDlg(wxWindow *parent, wxWindowID id, const wxString& title,
