...
static wxString className=wxT("PolyCurvePrimitive.h");
 ...
 */
PolyCurvePrimitive::PolyCurvePrimitive(bool frac) {
    wxLogTrace(className, wxT("Entering PolyCurvePrimitive"));
    wxLogTrace(className, wxT("Exiting PolyCurvePrimitive"));
}
 ...
 * @todo Complete the implementation
 */
PolyCurvePrimitive::PolyCurvePrimitive(VPoints lp, int c, StyleAttrib istyle) {
    wxLogTrace(className, wxT("Entering PolyCurvePrimitive"));
    wxLogTrace(className, wxT("Exiting PolyCurvePrimitive"));
}
 ...
 * @todo Complete the implementation
 */
PolyCurvePrimitive::PolyCurvePrimitive(VPoints lp, int c, int iseed, int irough, StyleAttrib istyle) {
    wxLogTrace(className, wxT("Entering PolyCurvePrimitive"));
    wxLogTrace(className, wxT("Exiting PolyCurvePrimitive"));
}
 ...
 * @todo Complete the implementation
 */
PolyCurvePrimitive::PolyCurvePrimitive(VPoints lp, int c, int iseed, int irough, StyleAttrib istyle, bool frac) {
    wxLogTrace(className, wxT("Entering PolyCurvePrimitive"));
    wxLogTrace(className, wxT("Exiting PolyCurvePrimitive"));
}
 ...
 * @todo Complete the implementation
 */
PolyCurvePrimitive::PolyCurvePrimitive(arRealPoint center, arRealPoint edge, StyleAttrib istyle) {
    wxLogTrace(className, wxT("Entering PolyCurvePrimitive"));
    wxLogTrace(className, wxT("Exiting PolyCurvePrimitive"));
}
 ...
 * @todo Complete the implementation
 */
PolyCurvePrimitive::PolyCurvePrimitive(arRealPoint center, arRealPoint edge1, arRealPoint edge2, StyleAttrib istyle) {
    wxLogTrace(className, wxT("Entering PolyCurvePrimitive"));
    wxLogTrace(className, wxT("Exiting PolyCurvePrimitive"));
}
 ...
 * @todo Complete the implementation
 */
DrawPrimitive* PolyCurvePrimitive::Copy() {
 ...
 * @todo Complete the implementation
 */
void PolyCurvePrimitive::CopyFromBase(bool AliasOnly) {
 ...
 * @todo Complete the implementation
 */
void PolyCurvePrimitive::ClearThis(bool Deallocate) {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::IsClosed() {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::Decompose(const ViewPoint& view, DrawPrimitive& NewChain, bool testinside) {
 ...
 * @todo Complete the implementation
 */
void PolyCurvePrimitive::Draw(ViewPoint view) {
 ...
 * @todo Complete the implementation
 */
void PolyCurvePrimitive::DrawHandles(const ViewPoint& view) {
 ...
 * @todo Complete the implementation
 */
void PolyCurvePrimitive::InvalidateHandles(const wxObject handle, const ViewPoint& view) {
 ...
 * @todo Complete the implementation
 */
void PolyCurvePrimitive::DrawOverlayHandles(const ViewPoint& view) {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::ApplyMatrix(Matrix3& mat) {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::FindHandle(const ViewPoint& view, coord x, coord y) {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::FindEndPoint(const ViewPoint& view, coord& x, coord& y) {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::FindPointOn(const ViewPoint& view, coord& x, coord& y, coord& angle) {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::MoveHandle(const ViewPoint& view, HandleMode& mode, coord origx, coord origy, coord dx, coord dy) {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::SetStyle(StyleAttrib new_style) {
 ...
 * @todo Complete the implementation
 */
StyleAttrib PolyCurvePrimitive::GetStyle() {
 ...
 * @todo Complete the implementation
 */
void PolyCurvePrimitive::Move(coord dx, coord dy) {
 ...
 * @todo Complete the implementation
 */
void PolyCurvePrimitive::ComputeExtent() {
 ...
 * @todo Complete the implementation
 */
void PolyCurvePrimitive::PointClosestTo(coord x, coord y, coord& px, coord& py) {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::SetFillColor(wxColour color) {
 ...
 * @todo Complete the implementation
 */
wxColour PolyCurvePrimitive::GetFillColor() {
 ...
 * @todo Complete the implementation
 */
VPoints PolyCurvePrimitive::GetLines(const ViewPoint& view, int& polycount) {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::SetSeed(int new_seed) {
 ...
 * @todo Complete the implementation
 */
int PolyCurvePrimitive::GetSeed() {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::SetRoughness(int rough) {
 ...
 * @todo Complete the implementation
 */
int PolyCurvePrimitive::GetRoughness() {
 ...
 * @todo Complete the implementation
 */
void PolyCurvePrimitive::CloseFigure() {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::FindScalpelPoint(const ViewPoint& view, coord x, coord y, int& index) {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::SeparateNode(const ViewPoint& view, int index, DrawPrimitive& NewObject) {
 ...
 * @todo Complete the implementation
 */
void PolyCurvePrimitive::DeleteNode(const ViewPoint& view, int index) {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::SliceAlong(arRealPoint s1, arRealPoint s2, DrawPrimitive& np) {
 ...
 * @todo Complete the implementation
 */
void PolyCurvePrimitive::Reverse() {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::SetFractal(FractalState state) {
 ...
 * @todo Complete the implementation
 */
wxString PolyCurvePrimitive::GetId() {
 ...
 * @todo Complete the implementation
 */
bool PolyCurvePrimitive::IsSimilarTo(DrawPrimitive& D) {
    wxLogTrace(className, wxT("Entering IsSimilarTo"));
    wxLogTrace(className, wxT("Exiting IsSimilarTo"));
}


void PolyCurvePrimitive::DoRead(wxFileInputStream& ins, int version, bool Full, bool UseAliasInfo) {
    wxLogTrace(className, wxT("Entering DoRead"));
    wxLogTrace(className, wxT("Exiting DoRead"));
}

void PolyCurvePrimitive::ReadFromDOMElement(wxXmlNode e, int version) {
    wxLogTrace(className, wxT("Entering ReadFromDOMElement"));
    wxLogTrace(className, wxT("Exiting ReadFromDOMElement"));
}

wxXmlNode PolyCurvePrimitive::GetAsDOMElement(wxXmlDocument D, bool undo) {
