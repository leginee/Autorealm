...
#ifndef CURVE_MODEL_TEST_H
#define CURVE_MODEL_TEST_H
...
/**
 * @brief This is the unit test class for the class CurveModel.
 * 
 * @todo Test all extreme values for the 'Set' methods.
 */
class CurveModelTest : public CppUnit::TestFixture 
{
        /**
         * @brief For setting up the test suite for CurveModelTest
         */
        CPPUNIT_TEST_SUITE(CurveModelTest);
    ...
    public:
        ...
        /**
         * @brief Test all constructors of the class CurveModel.
         */
    ...
    private:
        ...
        CurveModel *con3;
        /**
         * This are four arRealPoint object for the contructor test. Do not change
 ...
 */
RUNNERADD(CurveModelTest);


#endif  // CURVE_MODEL_TEST_H
