...
#ifndef POLY_LINE_MODEL_TEST_H
#define POLY_LINE_MODEL_TEST_H
...
/**
 * @brief This is the unit test class for the class PolyLineModel.
 * 
 * @todo Test all extreme values for the 'Set' methods.
 */
class PolyLineModelTest : public CppUnit::TestFixture 
{
        /**
         * @brief For setting up the test suite for PolyLineModelTest
         */
        CPPUNIT_TEST_SUITE(PolyLineModelTest);
    ...
    public:
         ...
         * to adds new points to the PolyLineModel. 
         */
        void checkGetCountAndAddPoint(void);

        /**
         * @brief Test all constructors of the class PolyLineModel.
         */
 ...
 */
RUNNERADD(PolyLineModelTest);


#endif  // POLY_LINE_MODEL_TEST_H
