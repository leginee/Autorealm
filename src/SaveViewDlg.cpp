...
static wxString className=wxT("SaveViewDlg");

IMPLEMENT_DYNAMIC_CLASS(SaveViewDlg, wxDialog)

BEGIN_EVENT_TABLE(SaveViewDlg, wxDialog)
END_EVENT_TABLE()
 ...
 */
SaveViewDlg::SaveViewDlg(wxWindow *parent, wxWindowID id, const wxString& title,
    const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    wxLogTrace(className, wxT("Entering SaveViewDlg"));
    Create(parent, id, title, pos, size, style, name);
    wxLogTrace(className, wxT("Exiting SaveViewDlg"));
}
 ...
 */
bool SaveViewDlg::Create(wxWindow *parent, wxWindowID id, const wxString& title,
    const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    
    wxLogTrace(className, wxT("Entering Create"));

    wxLogTrace(className, wxT("Loading resource"));
    wxXmlResource::Get()->LoadDialog(this, GetParent(), wxT("dlgSaveView"));
