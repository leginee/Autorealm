 ...
 * @file
 */
#ifndef DELETEVIEWDLG_H
#define DELETEVIEWDLG_H
#include "globals.h"
 ...
 * FULLDESC
 */
class DeleteViewDlg : public wxDialog {
    public:
        /**
         ...
         */
        DeleteViewDlg(wxWindow *parent, wxWindowID id, const wxString& title,
    ...
    private:
        DECLARE_DYNAMIC_CLASS(DeleteViewDlg)
        DECLARE_EVENT_TABLE()
};
#endif //DELETEVIEWDLG_H
