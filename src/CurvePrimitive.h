...
/**
 * This class is used to display a curve on the map
 *
 * @todo Document this class
 */
class CurvePrimitive : public DrawPrimitive {
    public:
        //Standard attributes
        arRealPoint p1;
        arRealPoint p2;
        ...
        CurvePrimitive();
        CurvePrimitive(arRealPoint ip1, arRealPoint ip2, arRealPoint ip3,
                arRealPoint ip4, StyleAttrib istyle);
        CurvePrimitive(arRealPoint ip1, arRealPoint ip2, arRealPoint ip3,
                arRealPoint ip4, int iseed, int rough, StyleAttrib istyle);
        CurvePrimitive(arRealPoint ip1, arRealPoint ip2, arRealPoint ip3,
                arRealPoint ip4, int iseed, int rough, StyleAttrib istyle,
                bool frac);
        ...
        arRealPoint GetAdjustedP1();
        arRealPoint GetAdjustedP2();
        arRealPoint GetAdjustedP3();
        arRealPoint GetAdjustedP4();
