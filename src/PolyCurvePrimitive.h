...
#ifndef POLYCURVEPRIMITIVE_H
#define POLYCURVEPRIMITIVE_H
...
/**
 * This class is used to display a polycurve on the map
 *
 * @todo Document this class
 */
class PolyCurvePrimitive: public DrawPrimitive {
    public:
        // Standard attributes
        StyleAttrib style;
        wxColour fillcolor;
        ...
        PolyCurvePrimitive(bool frac=false);
        PolyCurvePrimitive(VPoints lp, int c, StyleAttrib istyle);
        PolyCurvePrimitive(VPoints lp, int c, int iseed, int irough, StyleAttrib istyle);
        PolyCurvePrimitive(VPoints lp, int c, int iseed, int irough, StyleAttrib istyle, bool frac);
        PolyCurvePrimitive(arRealPoint center, arRealPoint edge, StyleAttrib istyle);
        PolyCurvePrimitive(arRealPoint center, arRealPoint edge1, arRealPoint edge2, StyleAttrib istyle);
        ...
        void InvalidateHandles(const wxObject handle, const ViewPoint& view);
