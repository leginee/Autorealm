 ...
 * @file 
 */
#ifndef POLYGONSIDESDLG_H
#define POLYGONSIDESDLG_H
#include "globals.h"
#include <wx/xrc/xmlres.h>

/**
 * @class PolygonSidesDlg
 *
 * @brief Descended from wxDialog, this class is used to BRIEFDESC
 *
 * FULLDESC
 */
class PolygonSidesDlg : public wxDialog {
    public:
        /**
         ...
         */
        PolygonSidesDlg(wxWindow *parent, wxWindowID id, const wxString& title,
    ...
    private:
        DECLARE_DYNAMIC_CLASS(PolygonSidesDlg)
        DECLARE_EVENT_TABLE()
};
#endif //POLYGONSIDESDLG_H
