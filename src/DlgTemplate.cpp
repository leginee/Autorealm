...
static wxString className=wxT("DlgTemplate");

IMPLEMENT_DYNAMIC_CLASS(DlgTemplate, wxDialog)
 ...
 */
DlgTemplate::DlgTemplate(wxWindow *parent, wxWindowID id, const wxString& title,
    const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    wxLogTrace(className, wxT("Entering DlgTemplate"));
    Create(parent, id, title, pos, size, style, name);
    wxLogTrace(className, wxT("Exiting DlgTemplate"));
}
 ...
 */
bool DlgTemplate::Create(wxWindow *parent, wxWindowID id, const wxString& title,
    const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
