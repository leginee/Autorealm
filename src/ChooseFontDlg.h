 ...
 * @file
 */
#ifndef CHOOSEFONTDLG_H
#define CHOOSEFONTDLG_H
#include "globals.h"
 ...
 * FULLDESC
 */
class ChooseFontDlg : public wxDialog {
    public:
        /**
         ...
         */
        ChooseFontDlg(wxWindow *parent, wxWindowID id, const wxString& title,
        ...
        void ItalicButtonClick();
        void UnderlineButtonClick();
        void AlignLeftButtonClick();
        void AlignCenterButtonClick();
        void AlignRightButtonClick();
        void CutMenuItemClick();
        void CopyMenuItemClick();
        void PasteMenuItemClick();
        void DeleteMenuItemClick();
        void CancelMenuItemClick();
        void TextContentEnter();
        void FormActivate();
        void FormShow();
        void TextContentChange();

    private:
        DECLARE_DYNAMIC_CLASS(ChooseFontDlg)
        DECLARE_EVENT_TABLE()
};
#endif //CHOOSEFONTDLG_H
