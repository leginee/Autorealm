 ...
 * @file
 */
#ifndef TMOVESELECTION_H
#define TMOVESELECTION_H
#include "globals.h"
#include <wx/xrc/xmlres.h>

/**
 * @class TMoveSelection
 *
 * @brief Descended from wxDialog, this class is used to BRIEFDESC
 *
 * FULLDESC
 */
class TMoveSelection : public wxDialog {
    public:
        /**
         ...
         */
        TMoveSelection(wxWindow *parent, wxWindowID id, const wxString& title,
    ...
    private:
        DECLARE_DYNAMIC_CLASS(TMoveSelection)
        DECLARE_EVENT_TABLE()
};
#endif //TMOVESELECTION_H
