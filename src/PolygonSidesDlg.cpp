...
#include "globals.h"
#include "PolygonSidesDlg.h"

#include "Map.xpm"

static wxString className=wxT("PolygonSidesDlg");

IMPLEMENT_DYNAMIC_CLASS(PolygonSidesDlg, wxDialog)

BEGIN_EVENT_TABLE(PolygonSidesDlg, wxDialog)
END_EVENT_TABLE()
 ...
 */
PolygonSidesDlg::PolygonSidesDlg(wxWindow *parent, wxWindowID id, const wxString& title,
    const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    wxLogTrace(className, wxT("Entering PolygonSidesDlg"));
    Create(parent, id, title, pos, size, style, name);
    wxLogTrace(className, wxT("Exiting PolygonSidesDlg"));
}
 ...
 */
bool PolygonSidesDlg::Create(wxWindow *parent, wxWindowID id, const wxString& title,
    const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    
    wxLogTrace(className, wxT("Entering Create"));

    wxLogTrace(className, wxT("Loading resource"));
    wxXmlResource::Get()->LoadDialog(this, GetParent(), wxT("dlgPolygonSides"));
...
PolygonSidesDlg* polygonsidesdlg=NULL;
